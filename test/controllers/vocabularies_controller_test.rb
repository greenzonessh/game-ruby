...
class VocabulariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vocabulary" do
    assert_difference('Vocabulary.count') do
      post vocabularies_url, params: { vocabulary: { is_active: @vocabulary.is_active, word: @vocabulary.word } }
    end
  ...
  test "should update vocabulary" do
    patch vocabulary_url(@vocabulary), params: { vocabulary: { is_active: @vocabulary.is_active, word: @vocabulary.word } }
